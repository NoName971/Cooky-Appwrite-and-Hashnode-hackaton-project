...
import 'package:hackaton_v1/features/favorite/controller/favorite_controller.dart';
...
class _FavoriteViewState extends ConsumerState<FavoriteView> {
  ...
  void deleteRecipe(recipeId) {
    Navigator.pop(context);
    ref.read(favoritesProvider.notifier).deleteRecipe(
          recipeId: recipeId,
          context: context,
          ref: ref,
        );
  ...
  Widget build(BuildContext context) {
    ...
    final isLoading = ref.watch(favoritesProvider);
