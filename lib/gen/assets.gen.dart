...
class $AssetsFontsGen {
  ...
  /// File path: assets/fonts/DMSans-Bold.ttf
  String get dMSansBold => 'assets/fonts/DMSans-Bold.ttf';

  /// File path: assets/fonts/DMSans-Medium.ttf
  String get dMSansMedium => 'assets/fonts/DMSans-Medium.ttf';
...
class $AssetsIconsGen {
  ...
  AssetGenImage get darkMode =>
      const AssetGenImage('assets/icons/dark_mode.png');
  ...
  /// File path: assets/icons/home_filled.png
  ...
  /// File path: assets/icons/person_filled.png
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/dark_overlay.png
  AssetGenImage get darkOverlay =>
      const AssetGenImage('assets/images/dark_overlay.png');

  /// File path: assets/images/meal.jpg
  AssetGenImage get meal => const AssetGenImage('assets/images/meal.jpg');

  /// List of all assets
  List<AssetGenImage> get values => [darkOverlay, meal];
}
